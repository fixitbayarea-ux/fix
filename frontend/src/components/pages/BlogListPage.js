...
const STATIC_POSTS = [
  { slug: 'refrigerator-not-cooling', title: "5 Common Reasons Your Refrigerator Isn't Cooling", excerpt: 'Is your fridge running but not keeping food cold? Learn the top 5 causes including compressor issues, dirty coils, and thermostat problems.', publish_date: '2025-01-20', categories: ['Refrigerator'], readTime: '5 min' },
  { slug: 'dishwasher-maintenance', title: 'How to Maintain Your Dishwasher for Longer Life', excerpt: 'Simple maintenance tips to prevent clogs, leaks, and odors. Learn how to clean filters, check spray arms, and maintain door seals.', publish_date: '2025-01-18', categories: ['Dishwasher'], readTime: '7 min' },
  { slug: 'when-to-repair-vs-replace', title: 'Repair vs Replace: When to Fix Your Appliance', excerpt: "Not sure if it's worth repairing your old appliance? Use our expert guide based on the 50% rule, age considerations, and repair costs.", publish_date: '2025-01-15', categories: ['Expert Advice'], readTime: '6 min' },
  { slug: 'dryer-taking-too-long', title: 'Why Is My Dryer Taking So Long to Dry?', excerpt: 'Long drying times waste energy and money. Discover the 7 most common causes including clogged vents, heating element issues, and moisture sensor problems.', publish_date: '2025-01-12', categories: ['Dryer'], readTime: '6 min' },
  { slug: 'washer-error-codes', title: 'Common Washer Error Codes & What They Mean', excerpt: 'Decode OE, UE, LE, and other error codes from Samsung, LG, Whirlpool, and GE washers. Learn what each code means and simple troubleshooting steps.', publish_date: '2025-01-10', categories: ['Washer', 'Error Codes'], readTime: '8 min' },
  { slug: 'oven-temperature-calibration', title: 'How to Calibrate Your Oven Temperature', excerpt: 'Is your oven cooking unevenly or burning food? Learn how to test oven temperature accuracy with a thermometer and calibrate for perfect results.', publish_date: '2025-01-08', categories: ['Oven'], readTime: '5 min' },
  { slug: 'ice-maker-troubleshooting', title: 'Ice Maker Not Working? Top 10 Fixes', excerpt: 'No ice, slow ice production, or small/hollow cubes? Troubleshoot water supply, ice maker module, and water filter issues.', publish_date: '2025-01-05', categories: ['Refrigerator'], readTime: '7 min' },
  { slug: 'appliance-lifespan', title: 'How Long Should Your Appliances Last?', excerpt: 'Expected lifespans for refrigerators, washers, dryers, dishwashers, and ovens. Learn when to start planning for replacement.', publish_date: '2025-01-03', categories: ['Expert Advice'], readTime: '6 min' },
  { slug: 'energy-efficient-appliances', title: 'How to Make Your Appliances More Energy Efficient', excerpt: 'Save money on electricity with these proven tips. Small changes can reduce energy bills by 10-25% annually.', publish_date: '2024-12-28', categories: ['Expert Advice', 'Maintenance Tips'], readTime: '7 min' },
