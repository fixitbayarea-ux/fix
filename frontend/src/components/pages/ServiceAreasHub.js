...
const FAQ_DATA = [
  ...
  { question: 'Is the $80 diagnostic fee applied to the repair?', answer: 'Yes. If you proceed with the repair, the $80 diagnostic is fully credited toward your final invoice. This means you only pay for the repair itself—the diagnostic visit is essentially free when you move forward with the work.' },
