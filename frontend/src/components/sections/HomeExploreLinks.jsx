      ...
      <div className="grid lg:grid-cols-2" style={{ gap: 18 }}>
        ...
        <div style={{ background: '#fff', borderRadius: 4, padding: 24, border: '1px solid #E5E2DD' }}>
          ...
          <div className="flex flex-wrap" style={{ gap: 10 }}>
            {[
              { href: '/refrigerator-repair', label: 'Refrigerator Repair' }, { href: '/washer-repair', label: 'Washer Repair' }, { href: '/dryer-repair', label: 'Dryer Repair' }, { href: '/dishwasher-repair', label: 'Dishwasher Repair San Francisco' }, { href: '/oven-repair', label: 'Oven Repair' }, { href: '/cooktop-repair', label: 'Cooktop Repair' }, { href: '/ice-maker-repair', label: 'Ice Maker Repair' }, { href: '/freezer-repair', label: 'Freezer Repair' }, { href: '/wine-cooler-repair', label: 'Wine Cooler Repair' }, { href: '/commercial-appliance-repair', label: 'Commercial Repair' }, { href: '/maintenance', label: 'Maintenance' },
            ].map(l => (
