...
const CorteMadera = () => {
  ...
  const faqData = [
    { question: 'Do you serve all Corte Madera neighborhoods?', answer: 'Yes! We serve the Town Center, Christmas Tree Hill, and all Corte Madera neighborhoods with same-day service availability.' },
  ...
  const serviceDescription = {
    ...
    paragraphs: [
      ...
      'Same-day service is available throughout Corte Madera with a $60 diagnostic fee credited toward repairs. We provide transparent estimates and back every repair with a 180-day warranty. Our licensed technicians service all major appliance brands.'
    ]
  };
  ...
  return (
    <div style={{ paddingTop: 0 }}>
      <ApplianceRepairPageNew
        ...
        pageTitle="Appliance Repair Corte Madera | Same-Day Service | FixitBay LLC"
        metaDescription="Professional appliance repair in Corte Madera. Same-day service near The Village. Licensed technicians, 180-day warranty. Call (760) 543-5733."
