...
const ResidentialApplianceRepairPage = () => {
  ...
  const faqData = [
    ...
    },
    {
      ...
      answer: 'We offer same-day and next-day appointments throughout San Francisco, Peninsula, and Marin County. When you book online or call (760) 543-5733, we will offer the earliest available time slot for your address. For urgent repairs affecting food storage or laundry needs, we prioritize scheduling to minimize inconvenience.'
    }
  ];
