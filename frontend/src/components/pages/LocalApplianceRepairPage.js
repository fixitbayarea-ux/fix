      ...
      <div style={{ fontFamily: F }}>
        ...
        <section data-testid="hero-section" style={{ background: "linear-gradient(rgba(13,27,42,0.94),rgba(13,27,42,0.94)),url('/background_new2.webp')", backgroundSize: 'cover', backgroundPosition: 'center 60%', minHeight: 540, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '80px 24px 56px', color: '#fff' }}>
          <div style={{ maxWidth: 780, margin: '0 auto', textAlign: 'center' }}>
            ...
            <div style={{ display: 'flex', gap: 16, justifyContent: 'center', flexWrap: 'wrap' }}>
              <a href="/book?go=1" target="_blank" rel="noopener noreferrer" className="phone-cta" style={{ background: '#FF5722', color: '#fff', fontFamily: F, fontWeight: 700, fontSize: 15, padding: '14px 32px', borderRadius: 4, textDecoration: 'none', transition: 'background 0.2s' }}>Book Online Now</a>
        ...
        <section data-testid="mid-cta" style={{ background: '#FF5722', padding: '48px 24px', textAlign: 'center' }}>
          ...
          <div style={{ display: 'flex', gap: 16, justifyContent: 'center', flexWrap: 'wrap' }}>
            ...
            <a href="/book?go=1" target="_blank" rel="noopener noreferrer" style={{ background: 'transparent', border: '2px solid rgba(255,255,255,0.5)', color: '#fff', fontFamily: F, fontWeight: 700, fontSize: 14, padding: '14px 28px', borderRadius: 4, textDecoration: 'none' }}>Book Online</a>
          </div>
        </section>
