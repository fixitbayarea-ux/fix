...
const serviceDescription = {
  ...
  paragraphs: [
    ...
    "Same-day and next-day Wolf repair throughout SF, Peninsula, and Marin County. 180-day warranty.",
  ],
};
const DesktopPage = () => (<ApplianceRepairPageNew appliance="Wolf Appliance" pageTitle="Wolf Appliance Repair San Francisco | FixitBay" metaDescription="Wolf range and oven repair in San Francisco & Bay Area. Dual-stacked burner specialists. Same-day service, 180-day warranty. Call (760) 543-5733." commonProblems={commonProblems} faqData={faqData} serviceDescription={serviceDescription} breadcrumbCategoryName="Brands" breadcrumbCategoryHref="/brands" relatedServicesCategory="Premium" relatedServicesSubtitle="Expert Wolf repair" />);
const MobilePage = () => (<MobileServiceLanding appliance="Wolf Appliance" pageSlug="wolf-appliance-repair" pageTitle="Wolf Appliance Repair San Francisco | FixitBay" metaDescription="Wolf repair in SF & Bay Area. Range & oven specialists. 180-day warranty." heroTitle={<>Wolf Appliance<br/>Repair. Same Day.</>} heroSubtitle="Wolf Range & Oven Experts"
