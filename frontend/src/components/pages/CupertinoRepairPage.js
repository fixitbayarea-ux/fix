  ...
  const cityData = {
    ...
    faqData: [
      ...
      },
      {
        ...
        answer: "Our service call fee is FREE with repair (otherwise $60). We provide upfront pricing before starting any work. Most repairs in Cupertino range from $250-$650 depending on the appliance and issue."
      },
      {
