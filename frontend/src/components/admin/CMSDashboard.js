    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <header className="bg-white shadow-md">
        <div className="max-w-7xl mx-auto px-4 py-4 flex justify-between items-center">
          <div>
            <h1 className="text-2xl font-bold text-gray-800">FixitBay CMS</h1>
                  ...
                  blogPosts.map((bp) => (
                    <div key={bp.slug} className="bg-white p-5 rounded-lg shadow-sm border border-gray-200 hover:shadow-md transition" data-testid={`cms-blog-${bp.slug}`}>
                      <div className="flex justify-between items-start">
                        ...
                        <div className="flex gap-2 flex-shrink-0">
                          <a href={`/blog/${bp.slug}`} target="_blank" rel="noreferrer" className="px-3 py-1.5 bg-gray-200 text-gray-700 rounded-lg hover:bg-gray-300 text-sm">
                            Просмотр
                          </a>
