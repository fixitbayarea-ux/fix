...
const PaloAltoRepairPage = () => {
  ...
  const faqData = [
    ...
    },
    {
      ...
      answer: "Appliance repair costs in Palo Alto typically range from $150-$400 depending on the appliance and issue. We provide free diagnostics with repair service (otherwise $60) and always offer transparent, upfront pricing."
    },
    {
