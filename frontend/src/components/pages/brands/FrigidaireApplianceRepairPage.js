...
const faqData = [
  ...
  { question: 'Same-day service?', answer: 'Yes — same-day and next-day throughout SF, Peninsula, and Marin County.' },
...
const MobilePage = () => (<MobileServiceLanding appliance="Frigidaire Appliance" pageSlug="frigidaire-appliance-repair" pageTitle="Frigidaire Appliance Repair San Francisco | FixitBay" metaDescription="Frigidaire repair in SF & Bay Area. Same-day service, 180-day warranty." heroTitle={<>Frigidaire<br/>Repair. Same Day.</>} heroSubtitle="Frigidaire Certified Technicians"
  ...
  faqs={[{q:'All Frigidaire models?',a:'Yes — standard, Gallery, and Professional lines.'},{q:'Genuine parts?',a:'OEM Frigidaire/Electrolux parts or equivalents.'},{q:'Same-day service?',a:'Yes — throughout SF, Peninsula, and Marin County.'},{q:'Warranty?',a:'180-day parts and labor warranty.'}]}
