...
const Sausalito = () => {
  ...
  const faqData = [
    ...
    { question: 'What\'s your response time to Sausalito?', answer: 'We typically arrive within 1-2 hours for same-day appointments, accessing Sausalito via Highway 101 and local routes.' },
  ...
  const serviceDescription = {
    ...
    paragraphs: [
      ...
      'Same-day service is available throughout Sausalito with a $60 diagnostic fee credited toward repairs. We carry specialized tools for premium appliances and can source high-end parts quickly. Every repair includes a 180-day warranty, and our licensed technicians are experienced with luxury appliances and challenging hillside installations.'
    ]
  };
