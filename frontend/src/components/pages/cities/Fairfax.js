...
const Fairfax = () => {
  ...
  const faqData = [
    { question: 'Do you serve all Fairfax neighborhoods?', answer: 'Yes! We serve downtown Fairfax, Manor, and all surrounding neighborhoods with same-day service.' },
    { question: 'What\'s your response time to Fairfax?', answer: 'We typically arrive within 1-2 hours for same-day appointments via Sir Francis Drake Boulevard and Highway 101.' },
  ...
  const serviceDescription = {
    ...
    paragraphs: [
      ...
      'Same-day service is available in Fairfax with a $60 diagnostic fee credited toward repairs. We provide transparent estimates and back every repair with a 180-day warranty. Our licensed technicians service all major appliance brands.'
    ]
  };
