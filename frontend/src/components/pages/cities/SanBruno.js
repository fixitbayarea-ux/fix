...
const SanBruno = () => {
  ...
  const faqData = [
    ...
    { question: 'What\'s your diagnostic fee in San Bruno?', answer: 'Our diagnostic fee is $80, which is fully credited toward your repair if you proceed. This covers the visit, testing, and written estimate.' },
  ...
  const serviceDescription = {
    ...
    paragraphs: [
      ...
      'Fast scheduling is standard in San Bruno with a $80 diagnostic fee credited toward all repairs. We provide transparent estimates before starting work and back every repair with a 180-day parts and labor warranty. Our licensed technicians service all major appliance brands and handle both traditional and high-efficiency models.'
    ]
  };
