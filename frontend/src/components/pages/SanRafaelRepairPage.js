...
const SanRafaelRepairPage = () => {
  const cityData = {
    ...
    metaDescription: "Expert appliance repair in San Rafael, CA. Licensed technicians, 180-day warranty, same-day service. Call (760) 543-5733 or book online now!",
    neighborhoods: [
      "Downtown San Rafael",
      "West End", 
      "Gerstle Park",
    ...
    faqData: [
      {
        question: "Do you offer same-day appliance repair in San Rafael?",
        answer: "Yes! We provide same-day appliance repair service throughout San Rafael, including Downtown, West End, Gerstle Park, and all surrounding neighborhoods. Call us before 2 PM for same-day availability."
      },
      {
