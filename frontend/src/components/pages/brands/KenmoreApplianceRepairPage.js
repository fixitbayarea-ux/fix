...
const DesktopPage = () => (<ApplianceRepairPageNew appliance="Kenmore Appliance" pageTitle="Kenmore Appliance Repair San Francisco | FixitBay" metaDescription="Kenmore appliance repair in San Francisco & Bay Area. Elite specialists. Same-day service, 180-day warranty. Call (760) 543-5733." commonProblems={commonProblems} faqData={faqData} serviceDescription={serviceDescription} breadcrumbCategoryName="Brands" breadcrumbCategoryHref="/brands" relatedServicesCategory="Kitchen" relatedServicesSubtitle="Expert Kenmore repair" />);
const MobilePage = () => (<MobileServiceLanding appliance="Kenmore Appliance" pageSlug="kenmore-appliance-repair" pageTitle="Kenmore Appliance Repair San Francisco | FixitBay" metaDescription="Kenmore repair in SF & Bay Area. Same-day service, 180-day warranty." heroTitle={<>Kenmore Appliance<br/>Repair. Same Day.</>} heroSubtitle="Kenmore & Elite Specialists"
