...
const faqData = [
  ...
  { question: 'Same-day Maytag repair?', answer: 'Yes — same-day and next-day throughout SF, Peninsula, and Marin County.' },
...
const serviceDescription = {
  ...
  paragraphs: [
    ...
    "Same-day and next-day service throughout SF Bay Area. 180-day warranty on parts and labor.",
  ],
};
const DesktopPage = () => (<ApplianceRepairPageNew appliance="Maytag Appliance" pageTitle="Maytag Appliance Repair San Francisco | FixitBay" metaDescription="Maytag appliance repair in San Francisco & Bay Area. Same-day service, 180-day warranty. Call (760) 543-5733." commonProblems={commonProblems} faqData={faqData} serviceDescription={serviceDescription} breadcrumbCategoryName="Brands" breadcrumbCategoryHref="/brands" relatedServicesCategory="Laundry" relatedServicesSubtitle="Expert Maytag repair" />);
const MobilePage = () => (<MobileServiceLanding appliance="Maytag Appliance" pageSlug="maytag-appliance-repair" pageTitle="Maytag Appliance Repair San Francisco | FixitBay" metaDescription="Maytag repair in SF & Bay Area. Same-day service, 180-day warranty." heroTitle={<>Maytag Appliance<br/>Repair. Same Day.</>} heroSubtitle="Maytag Certified Technicians"
  ...
  faqs={[{q:'All Maytag models?',a:'Yes — including commercial-grade residential models.'},{q:'Genuine parts?',a:'OEM Maytag/Whirlpool parts or equivalents.'},{q:'Same-day service?',a:'Yes — throughout SF, Peninsula, and Marin County.'},{q:'Warranty?',a:'180-day parts and labor warranty.'}]}
