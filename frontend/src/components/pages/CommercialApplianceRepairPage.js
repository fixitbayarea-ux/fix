...
const mobileFaqs = [
  { q: 'Do you offer priority service for commercial clients?', a: 'Yes. Commercial repair calls are prioritized for same- or next-day response. We offer flexible scheduling including early morning, evening, and weekend appointments.' },
