          ...
          <div className="tos-grid" style={{ maxWidth: 1000, margin: '0 auto', display: 'grid', gridTemplateColumns: '1fr 260px', gap: 40 }}>
            ...
            <div style={{ background: '#fff', borderRadius: 4, padding: '40px 36px', border: '1px solid rgba(255,87,34,0.1)' }}>
              ...
              <div style={secStyle}>
                ...
                <p style={P}>
                  Appointments can be scheduled by phone at <span style={B}>(760) 543-5733</span>, via text, or through our online booking system at fixitbay.net/book. We offer same-day and next-day appointment windows, subject to availability.
                </p>
