...
const Colma = () => {
  ...
  const faqData = [
    ...
    { question: 'What\'s your typical response time in Colma?', answer: 'We typically arrive within 1 hour for scheduled appointments in Colma. Our proximity allows for fast response to this compact service area.' },
    ...
    { question: 'What areas near Colma do you cover?', answer: 'We serve Colma and nearby Daly City, South San Francisco, San Bruno, Brisbane, and Pacifica with fast scheduling.' },
