...
const Novato = () => {
  ...
  const faqData = [
    { question: 'Do you serve all Novato neighborhoods?', answer: 'Yes! We serve downtown Novato, Bel Marin Keys, Hamilton, Ignacio, San Marin, and all other Novato areas with same-day service.' },
    { question: 'What\'s your response time to Novato?', answer: 'We typically arrive within 1-2 hours for same-day appointments via Highway 101.' },
  ...
  const serviceDescription = {
    ...
    paragraphs: [
      ...
      'Same-day service is available in Novato with a $60 diagnostic fee credited toward repairs. We provide transparent estimates and back every repair with a 180-day warranty. Our licensed technicians service all major brands.'
    ]
  };
