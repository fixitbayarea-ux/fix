  ...
  return (
    <>
      ...
      <style>{`
        ...
        @media(max-width:767px){.ty-hero h1{font-size:28px}}
      `}</style>
      ...
      <div className="ty-page">
        ...
        <section className="ty-review" data-testid="ty-review">
          ...
          <div className="ty-review-btns">
            <a href="https://www.google.com/maps/place/FixitBay" target="_blank" rel="noopener noreferrer" className="ty-review-btn" style={{ background: '#4285F4' }} data-testid="ty-review-google">Review on Google</a>
            <a href="https://www.yelp.com/biz/fixitbay" target="_blank" rel="noopener noreferrer" className="ty-review-btn" style={{ background: '#D32323' }} data-testid="ty-review-yelp">Review on Yelp</a>
            <a href="https://www.thumbtack.com/fixitbay" target="_blank" rel="noopener noreferrer" className="ty-review-btn" style={{ background: '#009fd9' }} data-testid="ty-review-thumbtack">Review on Thumbtack</a>
          </div>
