...
export default function ApplianceReplacementPage(){
  ...
  return (
    <main className="container" style={{padding:'24px'}}>
      <Helmet>
        <title>Appliance Replacement | FixItBay Appliance Repair & Maintenance</title>
        <meta name="description" content="Need a new appliance installed or an old unit replaced? We provide professional appliance replacement and installation across the Bay Area with transparent pricing and a 180-day workmanship warranty." />
