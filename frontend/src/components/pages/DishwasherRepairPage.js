...
const DishwasherRepairPage = () => {
  ...
  const faqData = [
    ...
    },
    {
      ...
      answer: "We offer same-day and next-day service for urgent dishwasher issues across San Francisco and the Bay Area. Most leak problems—like worn door seals, loose hose connections, or damaged spray arms—can be diagnosed and repaired within 1-2 hours. Our vans carry common dishwasher parts for faster repairs."
    },
    {
    ...
    },
    {
      ...
      answer: "Absolutely! We service dishwashers in all living situations—single-family homes, apartments, condos, and townhomes across San Francisco, the Peninsula, and North Bay."
    },
    {
  ...
  if (isMobile) {
    return (
      <MobileServiceLanding
        ...
        pageTitle="Dishwasher Repair San Francisco | Same-Day | FixitBay"
        metaDescription="Expert dishwasher repair in San Francisco. $60 diagnostic applied to repair. Licensed & insured. 180-day warranty."
        heroTitle={<>Expert Dishwasher<br />Repair in SF. Today.</>}
  ...
  return (
      ...
      faqData={faqData}
      serviceDescription={{
        title: "Dishwasher Repair San Francisco — Expert Same-Day Service",
        paragraphs: [
          <>Looking for professional <strong>dishwasher repair San Francisco</strong> homeowners trust? FixitBay delivers same-day service throughout San Francisco, the Peninsula, and North Bay. Our licensed technicians diagnose and fix most dishwasher issues on the first visit. We charge a transparent <strong>$60 diagnostic fee</strong> that's fully applied to your repair cost—no hidden charges.</>,
