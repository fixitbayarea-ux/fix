...
const STATIC_POSTS = [
  ...
  { slug: 'washer-error-codes', title: 'Common Washer Error Codes & What They Mean', excerpt: 'Decode OE, UE, LE, and other error codes from Samsung, LG, Whirlpool, and GE washers. Learn what each code means and simple troubleshooting steps.', publish_date: '2026-01-10', categories: ['Washer', 'Error Codes'], readTime: '8 min' },
