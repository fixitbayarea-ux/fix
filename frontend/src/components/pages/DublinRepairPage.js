...
const DublinRepairPage = () => {
  const cityData = {
    ...
    metaDescription: "Expert appliance repair in Dublin, CA. Licensed technicians, 180-day warranty, same-day service. Call (760) 543-5733 or book online now!",
    neighborhoods: [
      "East Dublin",
      "West Dublin", 
      "Emerald Glen",
    ...
    faqData: [
      {
        question: "Do you offer same-day appliance repair in Dublin?",
        answer: "Yes! We provide same-day appliance repair service throughout Dublin, including East Dublin, West Dublin, Emerald Glen, and all surrounding neighborhoods. Call us before 2 PM for same-day availability."
      },
      {
      ...
      },
      {
        ...
        answer: "Our service call fee is FREE with repair (otherwise $60). We provide upfront pricing before starting any work. Most repairs in Dublin range from $150-$400 depending on the appliance and issue."
      },
      {
