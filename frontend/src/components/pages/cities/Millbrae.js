...
const Millbrae = () => {
  ...
  const faqData = [
    ...
    { question: 'What\'s your response time in Millbrae?', answer: 'We typically arrive within 1-2 hours for same-day appointments in Millbrae, accessing the area via Highway 101, El Camino Real, and local routes.' },
  ...
  const serviceDescription = {
    ...
    paragraphs: [
      ...
      'Same-day service is available in Millbrae with a $60 diagnostic fee credited toward repairs. We provide detailed estimates before beginning work and back every repair with a 180-day warranty. Our licensed technicians repair all major appliance brands and are experienced with both standard and high-efficiency models common in Millbrae homes.'
    ]
  };
  ...
  return (
    <div style={{ paddingTop: 0 }}>
      <ApplianceRepairPageNew
        ...
        pageTitle="Appliance Repair Millbrae | Same-Day Service | FixitBay LLC"
        metaDescription="Professional appliance repair in Millbrae near BART, Caltrain. Same-day service. Licensed technicians, 180-day warranty. Call (760) 543-5733."
